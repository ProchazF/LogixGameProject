...
rozdíly mezi jednotlivými agenty založeny čistě na jejich algoritmech. Podrobnější implementační detaily jsou dostupné 
v elektronické příloze (viz příloha~\ref{app:electronic}).
